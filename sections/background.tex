...
\begin{table}[htb]
  ...
  \begin{tabular}{|m{2cm}||c|c|M{1.5cm}|M{1.5cm}|c|c|}
    ...
    \hline
  \end{tabular}
%  *** redo caption to give more explanation***  
...
Strava \cite{StravaInc.} is another fitness application that primarily focuses on running and cycling. It features a sleek user interface with similar functionalities as MapMyWalk. The journey view within the application can switch between either showing the map of your workout or a statistic screen as shown in Figure ***, visibly showing the time elapsed in the workout, the distance travelled and your average pace per kilometre

% add figure of stats screen in strava, will need to go on a walk to produce
...
The app is also focused on helping you maintain a balanced diet -- the amount of calories consumed can be added for particular meals during the day
