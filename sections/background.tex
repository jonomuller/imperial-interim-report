...
% maybe don't include
However, there are some advantages of Google Maps over Apple Maps -- one being that Google Maps tends to be more detailed than Apple Maps. An example of this is shown in Figure ***, where buildings are much easier to see on Google Maps than on Apple Maps.
...
Apple also provide a service for obtaining places called MKLocalSearch \cite{AppleInc.b}.

% add link to google places terms of use
